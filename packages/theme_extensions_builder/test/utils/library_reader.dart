...
Map<String, Map<String, String>> _fileCache = {};
...
Future<LibraryReader> libraryReader(
  ...
  final contentMap = () {
    if (_fileCache.containsKey(sourceDirectory)) {
      return _fileCache[sourceDirectory]!;
    }

    final toCache = Map.fromEntries(
    ...
    _fileCache[sourceDirectory] = toCache;
    return toCache;
  }();
